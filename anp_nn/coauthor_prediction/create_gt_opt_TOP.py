...
#     and co_author_candidates_history[author_node] not in [None, []]  # Controlla che non sia None o lista vuota
#     and (not isinstance(co_author_candidates_history[author_node], torch.Tensor) 
#          or co_author_candidates_history[author_node].numel() > 0)  # Se è un tensore, controlla che non sia vuoto
# ]
