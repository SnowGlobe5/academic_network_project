...
df_author_topic_counts = df_author_topics.groupby(['author_id', 'topic_id']).size().reset_index(name='count')
...
df_sorted.to_csv('../anp_data/raw/sorted_authors_topics.csv', index=False)

print("File 'sorted_authors_topics.csv' created successfully.")
