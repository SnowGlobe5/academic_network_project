...
plt.legend()
plt.savefig('output/anp_link_prediction_next_topic_infosphere_fold_loss.pdf')
plt.close()

plt.plot(accuracy_list,label='accuracy')
plt.legend()
plt.savefig('output/anp_link_prediction_next_topic_infosphere_fold_accuracy.pdf')