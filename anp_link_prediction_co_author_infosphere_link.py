...
plt.legend()
plt.savefig('output/anp_link_prediction_co_author_infosphere_link_loss.pdf')
plt.close()

plt.plot(accuracy_list,label='accuracy')
plt.legend()
plt.savefig('output/anp_link_prediction_co_author_infosphere_link_accuracy.pdf')